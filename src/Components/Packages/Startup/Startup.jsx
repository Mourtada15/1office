    ...
    <>
      ...
      <div className="virtual-office-wrapper d-flex flex-column gap-4">
        <div className="d-flex flex-column gap-2 virtual-office-wrapper-inner" style={{ width: "50%", margin: "auto" }} data-aos="zoom-in-up">
          ...
          <p>One Office will provide all the needed in terms of electricity, landline, Wi-Fi, fresh water, kitchenette which is well equipped,
            and even provide a virtual office option where you can have a physical address to register your start-up company.</p>
          <p>We even go the extra mile by providing you with 4 workstations, equipped with modern PCs in addition to a dedicated
            printer allowing unlimited printing.
          </p>
          ...
          <p>This option is comprised of TWO dedicated offices closely located to each other or within the same room to ensure your
            privacy.</p>
