import "./SmallBusinessPlus.css";
import Navbar from "../../Navbar/Navbar";
import Footer from "../../Footer/Footer";

const SmallBusinessPlus = () => {
    ...
    <>
      ...
      <div className="virtual-office-wrapper d-flex flex-column gap-4">
        <div className="d-flex flex-column gap-2" style={{ width: "50%", margin: "auto" }} >
          ...
          <p style={{ color: "red", fontWeight: "bold", fontSize: "x-large" }}>Same as Small Business yet 2 additional dedicated offices are provided, making a total of 6
            dedicated offices.</p>
          ...
          <p>1Office will also provide the following additional services to add to the already tempting package:
          </p>
          <ul>
          ...
          <h4>The Package is at US$ 1,750.00 per month</h4>
        </div>
...
export default SmallBusinessPlus;